                                    ...
                                    return <div className="table-row" key={column.name}>
                                        ...
                                        <div className="table-cell py-1 px-2 align-middle">
                                            <input
                                                ...
                                                type="text"
                                                autoComplete="off"
                                                className="resize-none appearance-none relative block h-6 w-full px-2 py-1 border border-gray-300 placeholder-gray-300 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
                                                placeholder="Titre"
                                            />
                                        </div>

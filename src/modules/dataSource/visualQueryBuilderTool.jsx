                                ...
                                <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dd className="select-none mt-1 text-xs text-gray-900 sm:mt-0 sm:col-span-2">{/* <pre>{columns && JSON.stringify(columns, null, 4)}</pre> */}
                                        <textarea
                                            ...
                                            type="textarea"
                                            required
                                            className="resize-none select-all appearance-none relative block w-full h-16 max-h-16 px-3 py-2 border border-gray-300 placeholder-gray-400 text-gray-900 rounded-md focus:placeholder-transparent focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-xs"
                                ...
                                <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dd className="select-none mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                        <input
                                            ...
                                            type="number"
                                            required
                                            className="resize-none appearance-none relative block h-9 w-full px-3 py-2 border border-gray-300 placeholder-gray-300 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
